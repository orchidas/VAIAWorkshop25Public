...
class HRIRSet:
    ...
    def get_spherical_harmonic_representation(self,
        ...
        W = spa.grids.calculate_grid_weights(incidence_az, incidence_zen,
                                             ambi_order)
        W = np.diag(W)
